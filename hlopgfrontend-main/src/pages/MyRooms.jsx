    ...
    const fetchPGs = async () => {
      try {
        ...
        try {
          ...
          const response = await api.get(`/api/hostel/owner/pgs`, {
            headers: { Authorization: `Bearer ${token}` }
          });
    ...
    const fetchRoomsAndConfig = async () => {
      ...
      try {
        ...
        try {
          ...
          const response = await api.get(`/api/hostel/rooms/pg/${selectedPG.hostel_id}`, {
            headers: { Authorization: `Bearer ${token}` }
          });
          ...
          try {
            ...
            const response = await api.get(`/api/hostel/${selectedPG.hostel_id}/rooms`, {
              headers: { Authorization: `Bearer ${token}` }
            });
  ...
  const updateRoomStatus = async (roomId, newStatus) => {
    try {
      ...
      try {
        ...
        await api.put(`/api/hostel/room/${roomId}/status`, 
          { status: newStatus },
          { headers: { Authorization: `Bearer ${token}` } }
        );
